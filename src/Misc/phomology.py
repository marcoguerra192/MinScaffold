...
def persistent_homology_calculation(clique_dictionary_file,max_homology_dimension,dataset_tag, output_dir,jython_call="jython ", script_dir=None, m1=2048,m2=2048,javaplex_directory=None,save_generators=False):
    ...
    # FORCE THE SCRIPT LOCATION
    if os.path.exists('/home/marco/PhD/SHB/scaffold/scaffold/Holes/jython_utils/persistent_homology_calculation.py'):
        script = '/home/marco/PhD/SHB/scaffold/scaffold/Holes/jython_utils/persistent_homology_calculation.py'
    else:
        rep_dir = os.path.dirname(Holes.__file__)
        script = os.path.join(diodir,'jython_utils','persistent_homology_calculation.py')
    
    # I just add it brutally - this is for my local UNIX machine
    if os.path.exists('/home/marco/javaplex/javaplex.jar'):
        javaplex_directory =  '/home/marco/javaplex/' 
    
    # This is for the remote isi machine
    if os.path.exists('/home/mguerra/javaplex/javaplex.jar'):
        javaplex_directory = '/home/mguerra/javaplex/'
       
    # This is for the Mac OsX Machine
    if os.path.exists('/Users/marco/javaplex/javaplex.jar'):
        javaplex_directory = '/Users/marco/javaplex/' 
